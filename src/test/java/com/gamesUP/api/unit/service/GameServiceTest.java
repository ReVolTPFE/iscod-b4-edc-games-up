...
class GameServiceTest {
    ...
    private final Author author = new Author(1L, "Author", null);
    private final Category category = new Category(1L, "Category", null);
    private final Publisher publisher = new Publisher(1L, "Publisher", null);
