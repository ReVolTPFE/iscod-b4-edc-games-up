...
class CategoryControllerTest {
    ...
    void getAllCategories_shouldReturnList() throws Exception {
        when(categoryService.getAllCategories()).thenReturn(List.of(new CategoryDto(1L, "Category1")));
    ...
    void getCategoryById_shouldReturnCategory() throws Exception {
        when(categoryService.getCategoryById(1L)).thenReturn(new CategoryDto(1L, "Category1"));
