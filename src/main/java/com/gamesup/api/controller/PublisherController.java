...
public class PublisherController {
    ...
    public ResponseEntity<ApiResponse<List<PublisherDto>>> getAllPublishers() {
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(HttpStatus.OK.value(), "Publishers fetched successfully", publishers)
        );
    }
    ...
    public ResponseEntity<ApiResponse<PublisherDto>> getPublisherById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(HttpStatus.OK.value(), "Publisher fetched successfully", publisher)
        );
    }
}
