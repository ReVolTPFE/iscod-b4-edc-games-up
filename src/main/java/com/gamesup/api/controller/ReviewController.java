...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<ReviewDto>> createReview(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(new ApiResponse<>(HttpStatus.CREATED.value(), "Review created successfully", review));
    }
    ...
    public ResponseEntity<ApiResponse<List<ReviewDto>>> getReviewsByGame(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Reviews fetched successfully", reviews));
    }
    ...
    public ResponseEntity<ApiResponse<List<ReviewDto>>> getReviewsByUser(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "User reviews fetched successfully", reviews));
    }
