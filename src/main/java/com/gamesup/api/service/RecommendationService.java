...
import com.gamesup.api.dto.recommendation.RecommendationApiResponse;
import com.gamesup.api.dto.recommendation.RecommendationItemDto;
...
public class RecommendationService {
    ...
    public RecommendationService(
            ...
            // I allow using Docker or local environment, default to localhost:5000
    ...
    public List<RecommendationItemDto> getRecommendationsForUser(Long userId) {
        ...
        // Formatting the payload for the recommendation API
